...
<div>
    <form action="/controller" method="post">
        ...
        <h6 class="display-4" style="text-align: center; color: blue"><fmt:message
                key="student_jsp.h6.page_main_head"/></h6>
            ...
            <table>
                <tr align="center">
                    <c:if test="${not empty sessionScope.user}">
                        ...
                        <ul class="bs-example border">
                            <%@ include file="/WEB-INF/jspf/common/show_student.jspf" %>
                        </ul>
                    </c:if>
                </tr>
                <br/>
                <tr>
                    <form>
                        ...
                        <input type="submit" value="<fmt:message key="student_jsp.btn.edit"/>" class="btn-primary"
